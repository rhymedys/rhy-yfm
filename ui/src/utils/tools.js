export const isWebBrowserRuntime = (onCb, notOnCb) => {
  const res = typeof window !== 'undefined' && typeof document !== 'undefined'
  if (res && Object.prototype.toString.call(onCb) === '[object Function]') {
    onCb()
  } else {
    Object.prototype.toString.call(notOnCb) === '[object Function]' && notOnCb()
  }
...
export const getIntersection = (arr1, arr2) => {
  ...
  while (++i < len) {
    const item = arr2[i]
    if (arr1.includes(item)) res.push(item)
  }
  return res
}
