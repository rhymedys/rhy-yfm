 ...
 * @Last Modified time: 2019-08-18 15:41:11
 */
...
const show = (options) => {
  ...
  const { storyBoardTaskInfoList, x, y, onMouseMove, onMouseOut } = options
  ...
  vm.top = top
  vm.storyBoardTaskInfoList = storyBoardTaskInfoList || []
}
